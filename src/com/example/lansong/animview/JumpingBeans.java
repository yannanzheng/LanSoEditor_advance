...
public final class JumpingBeans {
    ...
    /**
     * Create an instance of the {@link com.example.lansong.animview.JumpingBeans.Builder}
     * applied to the provided {@code TextView}.
     *
     * @param textView The TextView to apply the JumpingBeans to
     * @return the {@link com.example.lansong.animview.JumpingBeans.Builder}
     */
    ...
    /**
     * Builder class for {@link com.example.lansong.animview.JumpingBeans} objects.
     * <p/>
    ...
    public static class Builder {
         ...
         * resulting {@link com.example.lansong.animview.JumpingBeans}.
         *
         ...
         * {@link com.example.lansong.animview.JumpingBeans} instance.
         * <p/>
         * Remember to call the {@link #stopJumping()} method once you're done
         * using the JumpingBeans (that is, when you detach the TextView from
         * the view tree, you hide it, or the parent Activity/Fragment goes in
