 ...
 *
 */
public class BitmapLayer2ExecuteActivity extends Activity{
	...
	private void testDrawPadExecute()
	{
		...
		isExecuting=true;
		  ...
		  */
		 vDrawPad=new DrawPadVideoExecute(BitmapLayer2ExecuteActivity.this,videoPath,480,480,1000000,null,editTmpPath);
    ...
    protected void onDestroy() {
	   ...
	   private void initUI()
	   {
		     ...
		     findViewById(R.id.id_video_edit_btn2).setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						if(SDKFileUtils.fileExist(dstPath)){
							Intent intent=new Intent(BitmapLayer2ExecuteActivity.this,VideoPlayerActivity.class);
			    	    	intent.putExtra("videopath", dstPath);
			    	    	startActivity(intent);
						}else{
							 Toast.makeText(BitmapLayer2ExecuteActivity.this, "目标文件不存在", Toast.LENGTH_SHORT).show();
						}
					}
				});
	   ...
	   private void showHintDialog()
		...
		private void addCanvasLayer()
		{
					...
					if(mCanvasLayer!=null){
						...
						mShowHeart=new ShowHeart(BitmapLayer2ExecuteActivity.this,mCanvasLayer.getPadWidth(),mCanvasLayer.getPadHeight());
