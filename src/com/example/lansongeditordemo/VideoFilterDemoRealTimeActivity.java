 ...
 *
 */
public class VideoFilterDemoRealTimeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) 
    {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				 if(SDKFileUtils.fileExist(dstPath)){
		   			 	Intent intent=new Intent(VideoFilterDemoRealTimeActivity.this,VideoPlayerActivity.class);
			    	    	intent.putExtra("videopath", dstPath);
			    	    	startActivity(intent);
		   		 }else{
		   			 Toast.makeText(VideoFilterDemoRealTimeActivity.this, "目标文件不存在", Toast.LENGTH_SHORT).show();
		   		 }
			}
		});
        ...
        //增加提示缩放到480的文字.
        DemoUtils.showScale480HintDialog(VideoFilterDemoRealTimeActivity.this);
    }
    @Override
