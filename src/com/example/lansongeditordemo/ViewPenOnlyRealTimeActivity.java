...
import com.example.lansongeditordemo.view.LanSongLoveText;
 ...
 *  
 */
public class ViewPenOnlyRealTimeActivity extends Activity implements IEndListener{
    ...
    protected void onCreate(Bundle savedInstanceState) 
    {
        ...
        mDrawPadView = (DrawPadView) findViewById(R.id.id_viewPen_DrawPad_view);
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				 if(SDKFileUtils.fileExist(dstPath)){
		   			 	Intent intent=new Intent(ViewPenOnlyRealTimeActivity.this,VideoPlayerActivity.class);
			    	    	intent.putExtra("videopath", dstPath);
			    	    	startActivity(intent);
		   		 }else{
		   			 Toast.makeText(ViewPenOnlyRealTimeActivity.this, "目标文件不存在", Toast.LENGTH_SHORT).show();
		   		 }
			}
		});
...
//        dstPath="/sdcard/text2.mp4";
    ...
    private void addViewPen()
    {
        ...
        mGLRelativeLayout.bindViewPen(mViewPen);
