 ...
 *
 */
public class FilterPenRealTimeActivity extends Activity {
    ...
    private VideoFilterPen  filterPen=null;
    ...
    protected void onCreate(Bundle savedInstanceState) 
    {
        ...
        findViewById(R.id.id_filterPen_saveplay).setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				 if(SDKFileUtils.fileExist(dstPath)){
		   			 	Intent intent=new Intent(FilterPenRealTimeActivity.this,VideoPlayerActivity.class);
			    	    	intent.putExtra("videopath", dstPath);
			    	    	startActivity(intent);
		   		 }else{
		   			 Toast.makeText(FilterPenRealTimeActivity.this, "目标文件不存在", Toast.LENGTH_SHORT).show();
		   		 }
			}
		});
        ...
        //增加提示缩放到480的文字.
        DemoUtils.showScale480HintDialog(FilterPenRealTimeActivity.this);
    }
    @Override
...
//        		设置使能 实时保存, 即把正在DrawPad中呈现的画面实时的保存下来,实现所见即所得的模式
    ...
    private void addFilterPen()
    {
		 ...
		 */
		filterPen=mDrawPadView.addFilterPen(mplayer.getVideoWidth(),mplayer.getVideoHeight(),new GPUImageFilter());
