 ...
 *
 */
public class FilterExecuteDemoActivity extends Activity{
   ...
   @Override
	...
	private void startDrawPadExecute()
	{
		...
		if(mInfo.vRotateAngle==90 || mInfo.vRotateAngle==270){
		 ...
		 mDrawPad=new DrawPadVideoExecute(FilterExecuteDemoActivity.this,videoPath,padWidth,padHeight,
	...
	private void initView()
	{
		 ...
		 tvProgressHint=(TextView)findViewById(R.id.id_video_edit_progress_hint);
	      ...
	      findViewById(R.id.id_video_edit_btn2).setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					if(SDKFileUtils.fileExist(dstPath)){
						Intent intent=new Intent(FilterExecuteDemoActivity.this,VideoPlayerActivity.class);
		    	    	intent.putExtra("videopath", dstPath);
		    	    	startActivity(intent);
					}else{
						 Toast.makeText(FilterExecuteDemoActivity.this, "目标文件不存在", Toast.LENGTH_SHORT).show();
					}
				}
			});
	}
