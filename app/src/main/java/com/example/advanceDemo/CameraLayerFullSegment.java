...
public class CameraLayerFullSegment extends Activity implements OnClickListener{
     ...
     */
      private void startDrawPad()
      {
    		...
    		mCameraLayer=	mDrawPadView.addCameraLayer(false,new LanSongSkinWhitenFilter());  //使用前置相机,暂时不使用滤镜.
...
//  			}
	...
	private void addGifLayer2()
	{
	 ...
	 private void addMVLayer()
	  	{
	  		String  colorMVPath=CopyDefaultVideoAsyncTask.copyFile(CameraLayerFullSegment.this,"mei.mp4");
	  	    String maskMVPath=CopyDefaultVideoAsyncTask.copyFile(CameraLayerFullSegment.this,"mei_b.mp4");
   ...
   private void showWord()
   {
   	 		if(tvWord!=null&& tvWord.getVisibility()!=View.VISIBLE){
				 tvWord.startAnimation(AnimationUtils.loadAnimation(CameraLayerFullSegment.this, R.anim.slide_right_in));
				 ...
				 new Handler().postDelayed(new Runnable() {
					...
					public void run() {
						// TODO Auto-generated method stub
						 tvWord2.startAnimation(AnimationUtils.loadAnimation(CameraLayerFullSegment.this, R.anim.slide_right_in));
				 ...
				 new Handler().postDelayed(new Runnable() {
						...
						public void run() {
							// TODO Auto-generated method stub
							 tvWord3.startAnimation(AnimationUtils.loadAnimation(CameraLayerFullSegment.this, R.anim.slide_right_in));
   ...
   {
   	 	if(tvWord!=null&& tvWord.getVisibility()==View.VISIBLE){
				 tvWord.startAnimation(AnimationUtils.loadAnimation(CameraLayerFullSegment.this, R.anim.push_up_out));
				 ...
				 new Handler().postDelayed(new Runnable() {
					...
					public void run() {
						// TODO Auto-generated method stub
						 tvWord2.startAnimation(AnimationUtils.loadAnimation(CameraLayerFullSegment.this, R.anim.push_up_out));
				 ...
				 new Handler().postDelayed(new Runnable() {
						...
						public void run() {
							// TODO Auto-generated method stub
							 tvWord3.startAnimation(AnimationUtils.loadAnimation(CameraLayerFullSegment.this, R.anim.push_up_out));
   ...
   private void initView()
   {
	   ...
	   playVideo.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				 if(SDKFileUtils.fileExist(dstPath)){
		   			 	Intent intent=new Intent(CameraLayerFullSegment.this,VideoPlayerActivity.class);
			    	    	intent.putExtra("videopath", dstPath);
			    	    	startActivity(intent);
		   		 }else{
		   			 Toast.makeText(CameraLayerFullSegment.this, "目标文件不存在", Toast.LENGTH_SHORT).show();
		   		 }
			}
		});
