 ...
 *  
 */
public class ViewLayerOnlyRealTimeActivity extends Activity implements IEndListener{
    private static final String TAG = "ViewLayerPrivewDemoActivity";
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				 if(SDKFileUtils.fileExist(dstPath)){
		   			 	Intent intent=new Intent(ViewLayerOnlyRealTimeActivity.this,VideoPlayerActivity.class);
			    	    	intent.putExtra("videopath", dstPath);
			    	    	startActivity(intent);
		   		 }else{
		   			 Toast.makeText(ViewLayerOnlyRealTimeActivity.this, "目标文件不存在", Toast.LENGTH_SHORT).show();
		   		 }
			}
		});
