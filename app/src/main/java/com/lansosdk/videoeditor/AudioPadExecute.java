...
import com.lansosdk.box.AudioSuource;
...
public class AudioPadExecute {
	 ...
	 */
	public AudioSuource setAudioPadSource(String mainAudio,float volume)
	{
		 if(sampleMng!=null){
	 ...
	 * 开始线程前调用.
	 * 
	 * 如果您只想在 一整段音乐上增加别的音频,可以用 setAudioPadSource
	 * @return
	 */
	public AudioSuource setAudioPadLength(float  duration)
	{
		 if(sampleMng!=null){
	  ...
	  * @return
	  */
	 public AudioSuource addSubAudio(String srcPath,long startTimeMs,long endTimeMs,float volume) 
	 {
		 if(sampleMng!=null){
