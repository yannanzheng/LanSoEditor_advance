...
## 当前版本是2.4.2
*  视频H264编码器增加 CRF模式, 高通处理器在清晰度不变的情况下,文件大小同比降低30%--50%.
*  在用摄像机图层录制视频的时候, 把MIC声音实时增加到视频中,无须另外增加.
*  优化读取视频图片速度, 最高一秒钟可读取120帧画面,同时演示提取(25帧/60帧/所有帧)的UI界面, 
*  视频图层: 增加可对指定区域编辑功能.
*  优化其他代码和 增加客户需求的一些小细节功能.
